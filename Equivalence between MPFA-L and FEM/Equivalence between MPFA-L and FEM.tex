...
\begin{document}
	...
	\addcontentsline{toc}{section}{Modified MPFA-L method}
	...
	\addcontentsline{toc}{section}{Modified finite element method}
	...
	\addcontentsline{toc}{section}{convergence rate estimates}
...
The proof is trivial as our test space, $V_h \subset H^1(\Omega)\bigcap C(\Omega)$, consists of continuous functions.
	...
	\todo{What is this inner product?}
		as $\int_{\Gamma_N} (w_h-\hat{I}_{\Gamma_N} w_h) \ dx = 0$\todo{Does this make sense?}. Now, we can use Cauchy Schwarz inequality:
